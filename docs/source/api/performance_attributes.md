# Performance Attributes Reference

This page documents the PLEXOS Performance class attributes and their default
...
| Sparsify | - | -1 | In (-1,0,1,2) | Strategy for matrix sparsification during presolve |
